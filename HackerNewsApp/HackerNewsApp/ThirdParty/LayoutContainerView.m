...
-(void)updateWithModelArray:(NSMutableArray *)sortedArray{
    ...
    CommentModel *firstModel = [sortedArray firstObject];
    ...
    for (CommentModel *model in sortedArray) {
        ...
        LayoutView *vi =[[LayoutView alloc] initWithFrame:r model:model parentView:lastView isLast:[lastModel isEqual: model] isFirst:[firstModel isEqual: model]];
    ...
    self.frame = CGRectMake(0, 0,ScreenWidth, lastH+64);
