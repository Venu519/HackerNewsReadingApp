...
@property (nonatomic,assign) BOOL         isFirstFloor;

@end

@implementation LayoutView

- (instancetype)initWithFrame:(CGRect)frame model:(CommentModel *)amodel parentView:(UIView*)p isLast:(BOOL)isLast isFirst:(BOOL)isFirst
{
